...
void loop() {
  ...
  potPosition = (potPosition - SERVO_MAX) * -1;     // this will invert the value coming in

  servoPosition = map(potPosition, 0, 1023, 10, 170); //convert the potentiometer number to a servo position from 20-160
