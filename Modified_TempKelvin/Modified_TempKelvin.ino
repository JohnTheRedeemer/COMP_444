...
float degreesK = 0;                         //the temperature in Fahrenheit, calculated from the voltage
...
void loop() {
  ...
  degreesK = degreesC + 273.15; //convert the voltage to a temperature in degrees Fahrenheit
  ...
  lcd.print(degreesK);                      //print the degrees Fahrenheit
